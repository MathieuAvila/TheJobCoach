...
public final class Convertor {
	...
	static public String stringToSearchable(String inputStr)
	{
		return convertStringToAscii(inputStr).toLowerCase().replace(" ", "");
	}
	static public String convertStringToAscii(String inputStr)
	{
		String outputStr = "";
