...
import com.TheJobCoach.webapp.thejobcoach.shared.FieldVerifier;
...
public class GreetingServiceImpl extends RemoteServiceServlet implements
	...
	public Boolean createAccount(String userName, String userPassword, String email) throws IllegalArgumentException {
		System.out.println("Create account for: '" + userName + "' with password: '" + userPassword+ "' with EMail:'" + email + "'");
		return true;
	}
