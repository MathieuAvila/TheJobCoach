...
public interface LoginServiceAsync {
	void createAccount(String userName, String name, String firstName, String email, String password, String locale, UserId.UserType type, AsyncCallback<MainPageReturnCode.CreateAccountStatus> callback);
